...
const AboutPage = () => {
  return (
    <Fragment>
      ...
      <div className="img">
        <img src={ab} height="250px" width="180px" className="rnd"/></div>
        <h2 className="img">Jeo</h2>
        ...
        <h6 className="imgss">FOLLOW YOUR PASSION</h6>
         ...
         <div className="pad">
         <h8>We Are : </h8>
         <p>1. You can order in website by choosing cash on delivery or you can also order by making spot payment.</p>
         <p>2. But Both are online payment.</p>
         <p>3. One method is to pay   before you get the product.</p>
         <p>4.Other method is to pay after getting your product, When you getting your product you should pay within 12 hours in net banking.</p>
         <p>5. If there is any issues or damage in product you should convey it with proof then we will replace the product.</p>
